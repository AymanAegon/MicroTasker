(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_d5eb7072._.js", {
...
function FirebaseProvider({ children }) {
    ...
    const [firebaseData, setFirebaseData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FirebaseProvider.useEffect": ()=>{
            const initializeFirebase = {
                "FirebaseProvider.useEffect.initializeFirebase": async ()=>{
            ...
            }["FirebaseProvider.useEffect.initializeFirebase"];
            initializeFirebase();
        }
    }["FirebaseProvider.useEffect"], []);
...
_s(FirebaseProvider, "VuIlFBXWkG8nKXFIe1hgzAUWWQA=");
_c1 = FirebaseProvider;
const useFirebase = ()=>{
    _s1();
...
function AuthProvider({ children }) {
    ...
    const loadFirestore = async ()=>{
        try {
            const { getFirestore, doc, updateDoc } = await __turbopack_context__.r("[project]/node_modules/firebase/firestore/dist/esm/index.esm.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
            return {
                getFirestore,
                doc,
                updateDoc
                ...
                const unsubscribe = auth.onAuthStateChanged({
                    "AuthProvider.useEffect.unsubscribe": async (authUser)=>{
                        if (authUser && firebase) {
                            // User is signed in.
                            const { getFirestore, doc, getDoc } = await __turbopack_context__.r("[project]/node_modules/firebase/firestore/dist/esm/index.esm.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
    ...
    const signInWithGoogle = async ()=>{
        if (auth) {
            const provider = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$e84cf44d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__X__as__GoogleAuthProvider$3e$__["GoogleAuthProvider"]();
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$e84cf44d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__c__as__signInWithPopup$3e$__["signInWithPopup"])(auth, provider);
                router.push('/');
            } catch (error) {
    ...
    const createUser = async (email, password)=>{
        if (auth) {
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$e84cf44d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__aa__as__createUserWithEmailAndPassword$3e$__["createUserWithEmailAndPassword"])(auth, email, password);
                router.push('/');
            } catch (error) {
    ...
    const signIn = async (email, password)=>{
        if (auth) {
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$e84cf44d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__ab__as__signInWithEmailAndPassword$3e$__["signInWithEmailAndPassword"])(auth, email, password);
                router.push('/');
            } catch (error) {
...
_s2(AuthProvider, "PRnWfqzoa+wI9fSKwPahQ3HNuHk=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "FirebaseProvider");
__turbopack_context__.k.register(_c2, "AuthProvider");
...
//# sourceMappingURL=src_d5eb7072._.js.map